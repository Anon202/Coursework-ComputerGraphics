...
bool load_content()
{
    ...
    // Load in blur
    blur.add_shader("..\\resources\\shaders\\simple_texture.vert", GL_VERTEX_SHADER);
    blur.add_shader("..\\resources\\shaders\\blur.frag", GL_FRAGMENT_SHADER);

    // *****************************
    // Load in depth of field effect
    // *****************************
    dof.add_shader("..\\resources\\shaders\\simple_texture.vert", GL_VERTEX_SHADER);
    dof.add_shader("..\\resources\\shaders\\simple_texture.frag", GL_FRAGMENT_SHADER);
    // Build effects
    eff.build();
    blur.build();
    dof.build();
...
bool render()
{
    ...
    // ********************************
    // Set render target to first frame
    // ********************************
